...
1. **Modular Signature Separation:**
   - Decouple pipeline logic from textual prompt phrasing. Define tasks via declarative signatures (`Inputs -> Outputs`) and modular components (`dspy.ChainOfThought`, `dspy.Predict`).
